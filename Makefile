...
CPPFLAGS =
#FLAGS = -O3 -pg -pipe -ftracer -D_NO_FMOD_SOUND -fmerge-all-constants -ffast-math #-march=pentium4 --param max-crossjump-edges=2000 --param max-gcse-memory=209715200 --param max-gcse-passes=40 --param max-pending-list-length=1000 --param max-delay-slot-insn-search=2000 --param max-delay-slot-live-search=4000
#FLAGS = -O2 -pipe
FLAGS = -fno-builtin -g3 -ggdb3 -D_NO_FMOD_SOUND -D_SCC_DEBUG -ansi -pedantic-errors -Wall -W -Wmissing-braces -Wredundant-decls -Wundef -Wunused -Wconversion -Woverloaded-virtual -Wmissing-noreturn -Winline -Wdisabled-optimization -Wsign-promo -Wwrite-strings -Wlong-long -Woverloaded-virtual -Wfloat-equal -Wreturn-type -Wparentheses -Wchar-subscripts -Wimplicit  -Wtrigraphs  -Wendif-labels -Wpointer-arith -Wcast-qual -Wcast-align -Wwrite-strings -Wshadow #-Weffc++ 
#-Wold-style-cast
...
#-I/usr/local/include/fmodex 
CXX = g++

INCLUDES =  -lSDL -lSDL_ttf -lSDL_image -I/usr/include/SDL 
#-I/usr/local/include/fmodex /usr/local/lib/libfmodex.so
