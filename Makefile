...
EF_OBJ=$(EF)/bodiagram.o $(EF)/bograph.o $(EF)/bgwindow.o $(EF)/bowindow.o $(EF)/forceentry.o $(EF)/force.o $(EF)/info.o $(EF)/message.o $(EF)/statistics.o $(EF)/score.o $(EF)/mainwindow.o $(EF)/tutorial.o $(EF)/game.o  $(EF)/player.o $(EF)/main.o  $(EF)/racemenu.o $(EF)/menuentry.o $(EF)/menu.o $(EF)/setwindow.o $(EF)/progressbar.o $(EF)/unitmenu.o $(EF)/goalmenu.o $(EF)/forcemenu.o $(EF)/languagemenu.o $(EF)/resolutionmenu.o $(EF)/thememenu.o $(EF)/locmenu.o $(EF)/guimain.o $(EF)/boentry.o $(EF)/configuration.o $(EF)/endrundialog.o stl/misc.o
