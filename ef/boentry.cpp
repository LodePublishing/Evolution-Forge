...
BoEntry::BoEntry(UI_Object* bo_parent, const Point top_left, const Size distance_bottom_right, const std::string& bo_unit, const PROGRAM& bo_program) :
	UI_Button(bo_parent, Rect(top_left, Size(0,0)), distance_bottom_right, bo_unit, FORCE_ENTRY_BUTTON, PRESS_BUTTON_MODE, DO_NOT_ADJUST, SMALL_NORMAL_BOLD_FONT, NOTHING),
	program(bo_program)
//	fixed(false)
	// TODO!
{
