...
`$Welcome to Evolution Forge " + CORE_VERSION + " :)`$##\
~CLAWSOFTWARE_MONO_BITMAP~ # $What's it all about?$:#\
...
@~TITLE_SC_BITMAP~StarCraft@0@## Ah, yes, Starcraft :) I have worked on this ruleset quite some time so it should work flawlessly, even special rules like larvas, building add-ons, canceling buildings, morphing etc. is implemented.^#\
