...
IntroWindow::IntroWindow(UI_Object* intro_parent) :
	...
	doneButton(new UI_Button(this, Rect(0, 0, 50, 10), Size(20, 10), MY_BUTTON, false, PRESS_BUTTON_MODE, SAVE_BOX_OK_STRING, BOTTOM_RIGHT, LARGE_BOLD_FONT, AUTO_HEIGHT_CONST_WIDTH))
{
