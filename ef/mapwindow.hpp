#ifndef _GUI_MAP_WINDOW_HPP
#define _GUI_MAP_WINDOW_HPP
...
class MapWindow:public UI_Window
{
	public:
		MapWindow(UI_Object* mapwindow_parent);
		~MapWindow();
...
/*inline const bool MapWindow::hasLanguageChanged() const {
	return(languageHasChanged);
}

inline const bool MapWindow::hasResolutionChanged() const {
	return(resolutionHasChanged);
}

inline const bool MapWindow::hasBitDepthChanged() const {
	return(bitDepthHasChanged);
}

inline const bool MapWindow::hasFullScreenChanged() const {
