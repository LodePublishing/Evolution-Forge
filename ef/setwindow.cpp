...
SettingsWindow::SettingsWindow(UI_Object* setwindow_parent):
	...
	facilityMode(new UI_CheckButton(guiSettings, Rect(Point(20, 0), Size(200, 15)), SETTING_FACILITY_MODE_STRING, SETTING_FACILITY_MODE_TOOLTIP_STRING, configuration.isFacilityMode())),
...
//	allowGoalAdaption(new UI_CheckButton(coreSettings, Rect(Point(20, 120), Size(200, 15)), SETTING_ALLOW_GOAL_ADAPTION_STRING, SETTING_ALLOW_GOAL_ADAPTION_TOOLTIP_STRING, configuration.isAllowGoalAdaption())),
	...
	glowingButtons(new UI_CheckButton(guiSettings, Rect(Point(20, 15), Size(200, 15)), SETTING_GLOWING_BUTTONS_STRING, SETTING_GLOWING_BUTTONS_TOOLTIP_STRING, configuration.isGlowingButtons())),
	dnaSpiral(new UI_CheckButton(guiSettings, Rect(Point(20, 30), Size(200, 15)), SETTING_DNA_SPIRAL_STRING, SETTING_DNA_SPIRAL_TOOLTIP_STRING, configuration.isDnaSpiral())),
//	backgroundBitmap(new UI_CheckButton(guiSettings, Rect(Point(20, 45), Size(200, 15)), SETTING_BACKGROUND_BITMAP_STRING, SETTING_BACKGROUND_BITMAP_TOOLTIP_STRING, configuration.isBackgroundBitmap())),
	fullscreen(new UI_CheckButton(guiSettings, Rect(Point(20, 45), Size(200, 15)), SETTING_FULLSCREEN_STRING, SETTING_FULLSCREEN_TOOLTIP_STRING, configuration.isFullScreen())),
	tooltips(new UI_CheckButton(guiSettings, Rect(Point(20, 60), Size(200, 15)), SETTING_TOOLTIPS_STRING, SETTING_TOOLTIPS_TOOLTIP_STRING, configuration.isTooltips())),
...
//	transparency(new UI_CheckButton(guiSettings, Rect(Point(20, 105), Size(200, 15)), SETTING_TRANSPARENCY_STRING, SETTING_TRANSPARENCY_TOOLTIP_STRING, configuration.isTransparency())),
	smoothMovement(new UI_CheckButton(guiSettings, Rect(Point(20,  75), Size(200, 15)), SETTING_SMOOTH_MOVEMENT_STRING, SETTING_SMOOTH_MOVEMENT_TOOLTIP_STRING, configuration.isSmoothMovements())),
	allowStaticFramerate(new UI_CheckButton(guiSettings, Rect(Point(20,  90), Size(200, 15)), SETTING_ALLOW_STATIC_FRAMERATE_STRING, SETTING_ALLOW_STATIC_FRAMERATE_TOOLTIP_STRING, configuration.isAllowStaticFramerate())),
	staticFramerate(new UI_NumberField(guiSettings, Rect(Point(20, 105), Size(200, 15)), MIN_STATIC_FRAMERATE, MAX_STATIC_FRAMERATE, 1, configuration.getStaticFramerate(), SETTING_STATIC_FRAMERATE_STRING, SETTING_STATIC_FRAMERATE_TOOLTIP_STRING)),
	dynamicFramerate(new UI_NumberField(guiSettings, Rect(Point(20, 105), Size(200, 15)), MIN_DYNAMIC_FRAMERATE, MAX_DYNAMIC_FRAMERATE, 1, configuration.getDynamicFramerate(), SETTING_DYNAMIC_FRAMERATE_STRING, SETTING_DYNAMIC_FRAMERATE_TOOLTIP_STRING)),

	minimalistButton(new UI_Button(this, Rect(Point(0,0), Size(0, 15)), Rect(Point(250,215), Size(200, 15)), SETTING_MINIMALIST_STRING, MY_BUTTON, HORIZONTALLY_CENTERED_TEXT_MODE, STATIC_BUTTON_MODE, ARRANGE_LEFT, SMALL_NORMAL_BOLD_FONT, AUTO_SIZE_ONCE)),
	...
	loadFailsafeDefaultsButton(new UI_Button(loadSaveSettings, Rect(Point(0, 0), Size(0, 15)), getRelativeRect(), SETTING_LOAD_FAILSAFE_DEFAULTS_STRING, MY_BUTTON, HORIZONTALLY_CENTERED_TEXT_MODE, PRESS_BUTTON_MODE, ARRANGE_LEFT, SMALL_NORMAL_BOLD_FONT, AUTO_SIZE_ONCE)),
	saveToFileButton(new UI_Button(loadSaveSettings, Rect(Point(0, 0), Size(0, 15)), getRelativeRect(), SETTING_SAVE_TO_FILE_STRING, MY_BUTTON, HORIZONTALLY_CENTERED_TEXT_MODE, PRESS_BUTTON_MODE, ARRANGE_LEFT, SMALL_NORMAL_BOLD_FONT, AUTO_SIZE_ONCE)),
	languageMenu(new LanguageMenu(this, Rect(Point(230, 145),Size(200,100)))),
	languageMenuButton(new UI_Button(this, Rect(240, 120, 0,0), Rect(Point(150,215), Size(200, 15)), SETTING_LANGUAGE_STRING, MY_BUTTON, HORIZONTALLY_CENTERED_TEXT_MODE, STATIC_BUTTON_MODE, DO_NOT_ADJUST, SMALL_NORMAL_BOLD_FONT, AUTO_SIZE)),
