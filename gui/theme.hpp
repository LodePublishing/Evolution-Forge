...
//	END_FREEING_ANALYZED_DATA_STRING, // TODO :/
	...
	INTRO_MAIN_STRING,
	INTRO_SDL_STRING,
	INTRO_SDL_TTF_STRING,
	INTRO_SDL_IMAGE_STRING,
	INTRO_GUI_STRING,
	INTRO_SMPEG_STRING,
//#ifdef _FMOD_SOUND
	INTRO_FMOD_STRING,
//#elif _SDL_MIXER_SOUND
	INTRO_SDL_MIXER_STRING,
//#endif
	INTRO_CLICK_STRING,	
...
enum eAnimation
{
	...
	INTRO_MAIN_ANIMATION,
	INTRO_SDL_ANIMATION,
	INTRO_SDL_TTF_ANIMATION,
	INTRO_SDL_IMAGE_ANIMATION,
	INTRO_GUI_ANIMATION,
	INTRO_SMPEG_ANIMATION,
#ifdef _FMOD_SOUND
	INTRO_FMOD_ANIMATION,
#elif _SDL_MIXER_SOUND
	INTRO_MIXER_ANIMATION,
#endif
...
/*	CLICKED_SMALL_ARROW_LEFT_BITMAP,
	...
	INTRO_MAIN_BITMAP,
	INTRO_SDL_BITMAP,
	INTRO_SDL_TTF_BITMAP,
	INTRO_SDL_IMAGE_BITMAP,
	INTRO_GUI_BITMAP,
	INTRO_SMPEG_BITMAP,
#ifdef _FMOD_SOUND
	INTRO_FMOD_BITMAP,
#elif _SDL_MIXER_SOUND
	INTRO_SDL_MIXER_BITMAP,
#endif
...
class UI_Theme
{
	public:
		...
		void loadData(const std::string& data_file, const std::string& bitmap_dir, const std::string& animation_dir, const std::string& font_dir, DC* dc); //currently all data hard coded, move it to file later! TODO
		...
		/*const */SMPEG* lookUpAnimation(const eAnimation id);
		/*const */SMPEG_Info& lookUpAnimationInfo(const eAnimation id);
		...
		const eAnimation getAnimationFromIdentifier(const std::string& identifier) const;
