...
TutorialWindow::TutorialWindow(UI_Window* parentWindow):UI_Window(parentWindow, TUTORIAL_WINDOW_TITLE_STRING, TUTORIAL_WINDOW, NOT_SCROLLED, NO_AUTO_SIZE_ADJUST, TABBED)
{
...
void TutorialWindow::draw(DC* dc)
{
    if(!isShown()) return;
	UI_Window::draw(dc);
/*        int t=0;
