...
void DC::DrawTab_8bit(const signed int x, const signed int y, const unsigned int width, const unsigned int height) const
{
...
// ------ LEFT AND RIGHT VERTICAL LINE ------
	{
		register Uint8* p0 = (Uint8*)surface->pixels + Ycenter*surface->pitch + x;	 
		register Uint8* p1 = (Uint8*)surface->pixels + Ycenter*surface->pitch + x+width-1;
		register unsigned int i = dy + corner;
		for(;i--;p0+=surface->pitch, p1+=surface->pitch)
		{
			*p0 = bright_pen_col;
			*p1 = dark_pen_col;
...
void DC::DrawTab_16bit(const signed int x, const signed int y, const unsigned int width, const unsigned int height) const
{
	unsigned int corner = 4;
// Ecke links oben
	signed int Xcenter = x+corner;
...
void DC::DrawTab_24bit(const signed int x, const signed int y, const unsigned int width, const unsigned int height) const
{
	unsigned int corner = 4;
// Ecke links oben
	signed int Xcenter = x+corner;
...
void DC::DrawTab_32bit(const signed int x, const signed int y, const unsigned int width, const unsigned int height) const
{
	unsigned int corner = 4;
// Ecke links oben
	signed int Xcenter = x+corner;
