...
UI_Tooltip::UI_Tooltip(UI_Object* parent_object, const eString tooltip_text) :
	UI_StaticText(parent_object, tooltip_text==NULL_STRING?START_START_STRING:tooltip_text, Rect(5, 5, 450, 150), TEXT_COLOR, SMALL_ITALICS_BOLD_FONT, FORMATTED_NON_BLOCK_TEXT_MODE),
	boxSize()
{ 
	process();
}
